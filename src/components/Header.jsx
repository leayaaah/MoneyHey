...
const Header = () => (
    <header className="header-nav fixed-top d-flex align-items-center px-3 px-md-5">
        <div className="container-fluid d-flex justify-content-between align-items-center">
            <div className="fs-5 fs-md-4 fw-bold" style={{color: 'var(--emerald-primary)'}}>
                Money Hey
            </div>
            ...
            <div className="d-flex align-items-center gap-2">
                ...
                <button className="btn d-md-none border-0 p-1">
